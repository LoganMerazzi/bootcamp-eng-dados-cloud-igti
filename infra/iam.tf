  ...
  policy = <<EOF
{
    ...
    "Statement": [
        ...
        },
        {
            "Action": "iam:PassRole",
            "Resource": [
                "arn:aws:iam::579013474389:role/EMR_DefaultRole",
                "arn:aws:iam::579013474389:role/EMR_EC2_DefaultRole"],
            "Effect": "Allow"
        }
    ]
}
...
# Comentado para não ter permissões criadas desnecessariamente
